...
public class CubemapMain extends GVRMain {
    ...
    private GVRCubemapTexture mGVRCubemapTexture;
    ...
    private GVRAndroidResource[] mGVRAndroidResource = new GVRAndroidResource[6];
    ...
    public void onInit(GVRContext gvrContext) {
        ...
        try {
            for (int i = 0; i <= 5; i++) {
                int angle = i * 72;
                URL url = new URL("https://maps.googleapis.com/maps/api/streetview?size=1200x1200&location=40.720032,-73.988354&fov=120&heading=" + angle + "&pitch=10&key=AIzaSyA1zG5pP4M02eYBoB_1wmh1j9EmIy5L2Eo");
                mGVRAndroidResource[i] = new GVRAndroidResource(gvrContext, url);
                //GVRTexture texture = gvrContext.loadTexture(new GVRAndroidResource(gvrContext, url));
                //GVRSceneObject obj = new GVRSceneObject(gvrContext, 4.0f, 4.0f, texture);
        ...
        mGVRCubemapTexture = gvrContext.loadCubemapTexture(mGVRAndroidResource);
        mCubemapMaterial = new GVRMaterial(gvrContext, GVRMaterial.GVRShaderType.Cubemap.ID);
        mCubemapMaterial.setMainTexture(mGVRCubemapTexture);
    ...
    private void applyCubemap(GVRScene scene) {
        ...
        cubemapReflectionMaterial.setTexture("diffuseTexture", mGVRCubemapTexture);
